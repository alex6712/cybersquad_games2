...
@cybersquad_games.get("/", status_code=status.HTTP_200_OK, response_model=StandardResponse)
async def root():
    """
...
@cybersquad_games.get("/app_info", status_code=status.HTTP_200_OK, response_model=AppInfoResponse)
async def app_info():
    """
